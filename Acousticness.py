...
S3_FILE_NAME = 'training_acoustic.csv'
S3_URI = "s3://{0}/{1}".format(S3_BUCKET_NAME, S3_FILE_NAME)
DATA_SCHEMA =open("Acoustic.csv.schema").read()

DATA_SOURCE_ID = 'Acoustic0'
ML_MODEL_ID = 'Acoustic0'
...
response = client.create_data_source_from_s3(
    ...
    DataSourceName='finaldataAcoustic',
    DataSpec={
...
response1 = client.create_ml_model(
    ...
    MLModelName='finalmodelAcoustic',

...
S3_FILE_NAME = 'training_energy.csv'
S3_URI = "s3://{0}/{1}".format(S3_BUCKET_NAME, S3_FILE_NAME)
DATA_SCHEMA =open("Energy.csv.schema").read()

DATA_SOURCE_ID = 'Energy0'
ML_MODEL_ID = 'Energy0'
...
response = client.create_data_source_from_s3(
    ...
    DataSourceName='finaldataEnergy',
    DataSpec={

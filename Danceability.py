...
S3_FILE_NAME = 'training_dance.csv'
S3_URI = "s3://{0}/{1}".format(S3_BUCKET_NAME, S3_FILE_NAME)
DATA_SCHEMA =open("Danceability.csv.schema").read()

DATA_SOURCE_ID = 'danceability0'
ML_MODEL_ID = 'danceability0'
...
response = client.create_data_source_from_s3(
    ...
    DataSourceName='finaldataDanceability',
    DataSpec={
...
response1 = client.create_ml_model(
    ...
    MLModelName='finalmodelDanceability',
